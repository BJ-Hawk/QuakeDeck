...
const updates = [
  {
    code: '2020330',
    facility: '丸子地域自治センター',
    address: '長野県上田市上丸子1612番地',
    sourceUrl: 'https://www.city.ueda.nagano.jp/soshiki/mtiiki/1059.html',
  },
  {
    code: '2020333',
    facility: '武石地域自治センター',
    address: '長野県上田市下武石742番地',
    sourceUrl: 'https://www.city.ueda.nagano.jp/map/13805.html',
  },
];
