...
const updates = [
  {
    code: '2040330',
    facility: '高森町役場',
    address: '長野県下伊那郡高森町下市田2183番地1',
    sourceUrl: 'https://www.town.nagano-takamori.lg.jp/shisetsu/list/0101/',
  },
  {
    code: '2041130',
    facility: '下條村役場',
    address: '長野県下伊那郡下條村睦沢8801-1',
    sourceUrl: 'https://www.vill-shimojo.jp/gyousei/index.html',
  },
];
